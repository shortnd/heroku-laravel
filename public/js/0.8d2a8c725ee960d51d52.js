...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/logout').then(function (_ref) {
        var response = _ref.response;
        // console.log(response)
        inertia_vue__WEBPACK_IMPORTED_MODULE_1__["Inertia"].replace('/login'); // if (response.status === 401) {
