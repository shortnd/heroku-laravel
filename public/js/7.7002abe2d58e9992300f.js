...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deleteEntry: function deleteEntry(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a["delete"]("/tasks/".concat(this.task.id, "/").concat(id)).then(function (_ref) {
        var request = _ref.request;
        inertia_vue__WEBPACK_IMPORTED_MODULE_1__["Inertia"].replace("/tasks/".concat(_this.task.id), {
          preserveScroll: true
        });
