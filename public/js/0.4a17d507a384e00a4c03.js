...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      inertia_vue__WEBPACK_IMPORTED_MODULE_1__["Inertia"].replace('/login');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/logout').then(function (_ref) {// console.log(response)
