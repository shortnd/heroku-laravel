...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addEntry: function addEntry() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/tasks/".concat(this.task.id, "/new-entry"), this.form).then(function (_ref) {
        var request = _ref.request;
        console.log(response); // console.log(response.request.responseURL)
        // Inertia.visit({ responseURL })
