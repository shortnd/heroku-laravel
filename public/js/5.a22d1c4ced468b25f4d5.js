...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    inErrors: function inErrors(text) {
      return this.errors.contains(text) ? 'is-invalid' : '';
    }
  }
});
    ...
    _c("div", { staticClass: "container" }, [
      ...
      _c("form", [
        _c("div", { staticClass: "form-group" }, [
          ...
          _vm._v(" "),
          _vm._v(
            '=`inErrors(body)` @keyup.enter="addEntry" v-model="form.body" id="body" cols="30" rows="10" class="form-control">'
          )
        ]),
        _vm._v(" "),
